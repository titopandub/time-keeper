...
var _user$project$PrayTime$sunPosition = function (julianDate) {
	...
	var angularCorrection = function () {
		var x = _elm_lang$core$Basics$cos(
			_elm_lang$core$Basics$degrees(eclipticLongitude));
		var y = _elm_lang$core$Basics$cos(
...
var _user$project$PrayTime$toJulianDate = function (date) {
	...
	var julianYear = (_elm_lang$core$Native_Utils.cmp(month, 2) < 1) ? (year - 1) : year;
	var aVar = _elm_lang$core$Basics$floor(
		_elm_lang$core$Basics$toFloat(julianYear) / 100);
	var bVar = (2 - aVar) + _elm_lang$core$Basics$floor(
		_elm_lang$core$Basics$toFloat(aVar) / 4);
...
var _user$project$PrayTime$sunAngleTime = F5(
	function (latitude, angle, julianDate, time, direction) {
		...
		var tVar = (1 / 15) * ((_elm_lang$core$Basics$acos(beforeArcCos) * 180) / _elm_lang$core$Basics$pi);
		var _p1 = direction;
		if (_p1.ctor === 'CCW') {
			return noon + (-1 * tVar);
		} else {
...
var _user$project$PrayTime$adjustTimes = F3(
	function (longitude, timeZone, _p2) {
		...
		var magribTime = ((_p3.magrib + timeZone) - (longitude / 15)) + (2 / 60);
		var asrTime = ((_p3.asr + timeZone) - (longitude / 15)) + (2 / 60);
		var dhuhrTime = ((_p3.dhuhr + timeZone) - (longitude / 15)) + (2 / 60);
		var sunRiseTime = ((_p3.sunRise + timeZone) - (longitude / 15)) + (-2 / 60);
...
var _user$project$PrayTime$toTimeList = function (formattedTimes) {
	return {
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'Terbit', _1: formattedTimes.sunRise},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'Zuhur', _1: formattedTimes.dhuhr},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Ashar', _1: formattedTimes.asr},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'Magrib', _1: formattedTimes.magrib},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'Isya', _1: formattedTimes.isya},
							_1: {ctor: '[]'}
						}
					}
				}
